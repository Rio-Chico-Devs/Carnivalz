...
func dettagli_di(combattente: Dictionary) -> String:
	# LA MOSSA ANNUNCIATA NON STA QUI. C'e' stata per un po' (Campo.annuncio_di):
	# l'orda diceva cosa stava per fare e restava scritto sulla sua scheda. Bru:
	# «le cose vengono dette una volta, il giocatore deve stare attento, non e'
	# che glielo facciamo vedere sempre». Si legge nel box, e ci si ricorda
