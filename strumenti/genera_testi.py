...
SCHERMATE = [
    ...
    ("CartaNegozio.gd", "Negozio, le carte dello scaffale"),
    ("Personaggio.gd", "Scheda della squadra"),
    ("Corredo.gd", "Scheda della squadra, i conti"),
    ("SlotScheda.gd", "Scheda della squadra, il carosello dell'equipaggiamento"),
    ("CartaSquadra.gd", "Scheda della squadra, le carte dei compagni"),
    ("Pausa.gd", "Pausa, storico e Diario"),
    ("PaginePausa.gd", "Pausa, le pagine (zaino, opzioni)"),
