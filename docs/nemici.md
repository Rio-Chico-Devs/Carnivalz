...
Si combatte a turni: in ogni giro ognuno agisce una volta, in ordine di velocità, e quando
tocca a te il mondo aspetta. Una *battuta* è un turno di quella creatura — «per 3 battute»
vuol dire **tre volte che tocca a lei**, non tre giri e non tre tue mosse.

Il che vuol dire due cose che vale la pena avere in testa:

- **dura più a lungo su una creatura lenta.** Chi è molto più lento del protagonista non
  muove a ogni giro (va al suo ritmo, mai sotto due giri su cinque): un corazzato che si
  irrigidisce «per 3 battute» resta chiuso per sette o otto giri, uno veloce quanto te per
  tre. È coerente — sono tre sue azioni in tutti e due i casi — ma a schermo si sente come
  una durata diversa;
